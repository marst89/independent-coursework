...
def entries_histogram(turnstile_weather):
    ...
    '''
    plt.figure()
    turnstile_weather[turnstile_weather['rain'] == 0]['ENTRIESn_hourly'].hist(bins=20, alpha=0.6)
    turnstile_weather[turnstile_weather['rain'] == 1]['ENTRIESn_hourly'].hist(bins=20, alpha=0.6) # your code here to plot a historgram for hourly entries when it is raining
